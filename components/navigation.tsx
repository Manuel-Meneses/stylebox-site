...
export function Navigation() {
  ...
  return (
    ...
    >
      <nav className="flex items-center justify-between px-6 py-3 md:px-12 lg:px-20">

        {/* ↓ Logo con cambio de color según scroll */}
        <Link href="/" className="block">
          <Image
            ...
            className={`transition-all duration-500 ${
              scrolled
                ? "brightness-100 invert-0"   // color original
                : "brightness-0 invert"        // blanco puro
            }`}
          />
        </Link>
